...
<div class="header">
	<h2>
		<span style="margin-left: 15px; margin-top: 15px; " class="label">SHOE
			...
			<a href="${initParam.param2}?action=viewCart"><span style="float:right; margin:20px; margin-right:30px; font-size:30px" class="label" >Cart</span></a>
			<c:if test="${sessionScope.loginStatus == 'false'}">
			<a href="${initParam.param3}?action=loginRegister"><span style="float:right; margin:20px; margin-right:100px; font-size:30px" class="label" >Login/Register</span></a>
			</c:if>
